export const QUERY_KEYS = {
  wines: {
    all: ['wines'] as const,
    list: (filters: any) => ['wines', 'list', filters] as const,
    detail: (id: string) => ['wines', 'detail', id] as const,
  },
  grapes: {
    all: ['grapes'] as const,
    list: (filters: any) => ['grapes', 'list', filters] as const,
    detail: (id: string) => ['grapes', 'detail', id] as const,
  },
  wineries: {
    all: ['wineries'] as const,
    list: (filters: any) => ['wineries', 'list', filters] as const,
    detail: (id: string) => ['wineries', 'detail', id] as const,
  },
  tours: {
    all: ['tours'] as const,
    list: (filters: any) => ['tours', 'list', filters] as const,
