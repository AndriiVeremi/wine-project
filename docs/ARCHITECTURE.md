...
Документ описує загальну архітектуру Wine Project.

---

## Огляд

Wine Project — це веб-платформа для дослідження винної індустрії, побудована за архітектурою **клієнт-сервер**.
