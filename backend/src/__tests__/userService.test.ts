...
describe('userService', () => {
  describe('getUserProfileByFirebaseUid', () => {
    it('should throw error if firebaseUid is empty', async () => {
      await expect(userService.getUserProfileByFirebaseUid('')).rejects.toThrow('Firebase UID is required');
    });
    ...
    it('should throw 404 if user not found', async () => {
      ...
      await expect(userService.getUserProfileByFirebaseUid('nonexistent-uid')).rejects.toThrow('User profile not found.');
    });
  ...
  describe('getUserFavorites', () => {
    it('should throw 404 if user not found', async () => {
      ...
      await expect(userService.getUserFavorites('nonexistent-id')).rejects.toThrow('User not found');
    });
  ...
  describe('addFavoriteWine', () => {
    it('should throw 404 if user not found', async () => {
      ...
      await expect(userService.addFavoriteWine('user-id', 'wine-id')).rejects.toThrow('User not found');
    });
    ...
    it('should throw 404 if wine not found', async () => {
      ...
      await expect(userService.addFavoriteWine('user-id', 'wine-id')).rejects.toThrow('Wine not found');
    });
    ...
    it('should throw 400 if wine already in favorites', async () => {
      ...
      await expect(userService.addFavoriteWine('user-id', 'wine-id')).rejects.toThrow('Wine is already in favorites');
    });
  });
  ...
  describe('removeFavoriteWine', () => {
    it('should throw 404 if user not found', async () => {
      ...
      await expect(userService.removeFavoriteWine('user-id', 'wine-id')).rejects.toThrow('User not found');
    });
    ...
    it('should throw 404 if wine not in favorites', async () => {
      ...
      await expect(userService.removeFavoriteWine('user-id', 'wine-id')).rejects.toThrow('Wine not found in favorites');
    });
  });
});
