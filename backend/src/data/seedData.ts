...
export const grapes = [
  ...
  },
  {
    ...
    name: 'Rkatsiteli',
    type: 'white',
    regions: [kakhetiId, shidaKartliId, kvemoKartliId, zakarpattiaId, odesaId],
    alsoKnownAs: ['Topoli', 'Budeshuriseburi'],
    description:
  ...
  },
  {
    ...
    alsoKnownAs: ['Chkhaveri Rose', 'Chkhaveri Amber'],
    description:
  ...
  },
  {
    ...
    name: 'Chinuri',
    type: 'white',
    regions: [shidaKartliId, mtskhetaId],
    alsoKnownAs: ['Kaspuri'],
    description:
      'A distinguished white grape from Kartli, essential for the region sparkling and natural wines. It provides high acidity and a clean mineral profile, making it perfect for Qvevri winemaking with long skin contact.',
    characteristics: [
      'High acidity',
      'Mineral profile',
      'Great for sparkling',
    ...
    foodPairing: ['Fresh river fish', 'Vegetarian dishes', 'Walnut appetizers', 'Light cheese'],
    acidity: 'High',
    body: 'Medium-Light',
    aromas: ['Mint', 'Wild herbs', 'Green pear', 'Citrus'],
    agingPotential: '5-10 years',
    imageUrls: ['https://placehold.co/400x600/ECEFF1/333333?text=Chinuri'],
  },
  {
    _id: goruliMtsvaneId,
    name: 'Goruli Mtsvane',
    type: 'white',
    regions: [shidaKartliId],
    alsoKnownAs: ['Green of Gori'],
    description:
      'A rare and distinctive variety from the Gori district in Kartli. It is known for its energetic character, high sugar potential, and complex aromatic profile that often includes lime and floral notes.',
    characteristics: ['High energy', 'Aromatic intensity', 'Late ripening', 'Fresh character'],
    foodPairing: ['Herb-crusted chicken', 'Green salads', 'White fish', 'Pesto pasta'],
    acidity: 'Medium-High',
    body: 'Medium',
    aromas: ['Lime', 'Green apple', 'Spring flowers', 'Herbs'],
    agingPotential: '3-6 years',
    imageUrls: ['https://placehold.co/400x600/9CCC65/333333?text=Goruli+Mtsvane'],
  },
  {
    _id: budeshuriId,
    name: 'Budeshuri',
    type: 'white',
    regions: [kakhetiId, mtskhetaId],
    alsoKnownAs: ['Budeshuri Tetri'],
    description:
      'A secondary but important Georgian variety, often used in blends to add freshness and floral aromatics. It has large, thin-skinned berries and produces light, elegant wines.',
    characteristics: ['Thin-skinned', 'Floral aromatics', 'Fresh finish', 'Elegant texture'],
    foodPairing: ['Fruit tarts', 'Soft goat cheese', 'Light poultry', 'Shellfish'],
    acidity: 'Medium',
    body: 'Light',
    aromas: ['White flower', 'Nectarine', 'Melon'],
    agingPotential: '2-4 years',
    imageUrls: ['https://placehold.co/400x600/FFB6C1/333333?text=Budeshuri'],
  },
  {
